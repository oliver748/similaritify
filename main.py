...
def main():
    ...
    parser.add_argument('-r', '--resize-images', type=bool, required=False, default=True, help='Resize images (True by default)')

    args = parser.parse_args()

    methods_list = args.methods.split(',')

    dic = similaritify.run(image_1=args.i1, image_2=args.i2, methods=methods_list, target_width=args.target_width, resize_images=args.resize_images)
